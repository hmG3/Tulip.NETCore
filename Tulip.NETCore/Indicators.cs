...
namespace Tulip
{
    public static class Indicators
    {
        ...
        public static Indicator sub = new Indicator(77, nameof(sub), "Vector Subtraction", "real|real", String.Empty, nameof(sub));

        public static Indicator sum = new Indicator(78, nameof(sum), "Sum Over Period", "real", "period", nameof(sum));

        public static Indicator tan = new Indicator(79, nameof(tan), "Vector Tangent", "real", String.Empty, nameof(tan));

        public static Indicator tanh = new Indicator(80, nameof(tanh), "Vector Hyperbolic Tangent", "real", String.Empty, nameof(tanh));

        public static Indicator tema = new Indicator(81, nameof(tema), "Triple Exponential Moving Average", "real", "period", nameof(tema));

        public static Indicator todeg = new Indicator(82, nameof(todeg), "Vector Degree Conversion", "real", String.Empty, "degrees");

        public static Indicator torad = new Indicator(83, nameof(torad), "Vector Radian Conversion", "real", String.Empty, "radians");

        public static Indicator tr = new Indicator(84, nameof(tr), "True Range", "high|low|close", String.Empty, nameof(tr));
        ...
        public static Indicator trunc = new Indicator(87, nameof(trunc), "Vector Truncate", "real", String.Empty, nameof(trunc));
        ...
        public static Indicator typprice =
            new Indicator(89, nameof(typprice), "Typical Price", "high|low|close", String.Empty, nameof(typprice));

        public static Indicator ultosc =
            new Indicator(90, nameof(ultosc), "Ultimate Oscillator", "high|low|close", "short period|medium period|long period",
                nameof(ultosc));
        ...
        public static Indicator vidya =
            new Indicator(93, nameof(vidya), "Variable Index Dynamic Average", "real", "short period|long period|alpha", nameof(vidya));

        public static Indicator volatility =
            new Indicator(94, nameof(volatility), "Annualized Historical Volatility", "real", "period", nameof(volatility));

        public static Indicator vosc =
            new Indicator(95, nameof(vosc), "Volume Oscillator", "volume", "short period|long period", nameof(vosc));

        public static Indicator vwma =
            new Indicator(96, nameof(vwma), "Volume Weighted Moving Average", "close|volume", "period", nameof(vwma));

        public static Indicator wad =
            new Indicator(97, nameof(wad), "Williams Accumulation/Distribution", "high|low|close", String.Empty, nameof(wad));

        public static Indicator wcprice =
            new Indicator(98, nameof(wcprice), "Weighted Close Price", "high|low|close", String.Empty, nameof(wcprice));
        ...
        public static Indicator zlema =
            new Indicator(102, nameof(zlema), "Zero-Lag Exponential Moving Average", "real", "period", nameof(zlema));
    }
}
