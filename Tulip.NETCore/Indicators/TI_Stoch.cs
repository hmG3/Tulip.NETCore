...
namespace Tulip
{
    ...
    {
        private static int StochStart(double[] options)
        {
        ...
        private static int StochStart(decimal[] options)
        {
            int kPeriod = (int) options[0];
            int kSlow = (int) options[1];
            int dPeriod = (int) options[2];
        ...
        private static int Stoch(int size, double[][] inputs, double[] options, double[][] outputs)
        {
            ...
            double max = high[0];
            double min = low[0];
            var kSum = BufferDoubleNew(kSlow);
            var dSum = BufferDoubleNew(dPeriod);
        ...
        private static int Stoch(int size, decimal[][] inputs, decimal[] options, decimal[][] outputs)
        {
            ...
            decimal max = high[0];
            decimal min = low[0];
            var kSum = BufferDecimalNew(kSlow);
            var dSum = BufferDecimalNew(dPeriod);
            int stochIndex = default;
            int stochMaIndex = default;
            for (var i = 0; i < size; ++i)
            {
